		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGearetAccess().getGroup(), "rule__Gearet__Group__0");
					put(grammarAccess.getModelAccess().getVertragsAssignment(), "rule__Model__VertragsAssignment");
					...
					put(grammarAccess.getGearetAccess().getNameAssignment_1(), "rule__Gearet__NameAssignment_1");
					put(grammarAccess.getGearetAccess().getSystemAssignment_3(), "rule__Gearet__SystemAssignment_3");
					put(grammarAccess.getGearetAccess().getMarkeAssignment_4(), "rule__Gearet__MarkeAssignment_4");
					put(grammarAccess.getGearetAccess().getSpeicherAssignment_5(), "rule__Gearet__SpeicherAssignment_5");
